...
- [ ] Ship: commit/push authorized changes; no Worker deploy unless server changes. Explicit Pages deployment with actual runtime commit. Verify executed live bundle; update canonical handoff/release receipt/shared worklog and record deferred replacement decision.
